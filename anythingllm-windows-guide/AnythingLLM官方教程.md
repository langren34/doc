...
![AnythingLLM 官方介绍图](anythingllm-official-images/01-introduction-header.png)
...
![Windows 安装官方图](anythingllm-official-images/02-windows-header.png)
...
![安装过程图](anythingllm-official-images/03-install-process.png)
*图 2-2：官方安装过程截图*
...
![AnythingLLM 桌面打开图](anythingllm-official-images/04-desktop-open.png)
*图 2-3：官方启动后的桌面截图*
...
![安装错误图](anythingllm-official-images/05-installation-error.png)
*图 2-4：官方错误截图*
