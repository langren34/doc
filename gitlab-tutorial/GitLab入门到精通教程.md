...
![创建组入口](images/gitlab-5.1.6b-create-group-form.png)
...
![组成员列表](images/gitlab-5.1.6c-group-members-list.png)
...
![项目 Members 页 — 成员标签](images/gitlab-5.1.6d-invite-member-skills.png)
...
![项目 Members 页 — 群组标签](images/gitlab-5.1.6e-share-with-group.png)
...
![alice 视角](images/gitlab-5.1.7a-alice-developer-skills.png)
...
![bob 视角](images/gitlab-5.1.7b-bob-maintainer-skills.png)
...
![carol 视角](images/gitlab-5.1.7c-carol-reporter-skills.png)
...
![carol 无权访问](images/gitlab-5.1.7d-carol-forbidden-dev-sample.png)
...
![未登录访问 Private](images/gitlab-5.1.7e-anonymous-private.png)
