...
![AnythingLLM 官方介绍图](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/01-introduction-header.png)
...
![Windows 安装官方图](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/02-windows-header.png)
...
![安装过程图](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/03-install-process.png)
*图 2-2：官方安装过程截图*
...
![AnythingLLM 桌面打开图](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/04-desktop-open.png)
*图 2-3：官方启动后的桌面截图*
...
![安装错误图](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/05-installation-error.png)
*图 2-4：官方错误截图*
...
![安装成功后的真实界面](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/06-current-workspace-annotated.png)
...
![设置页入口](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/05b-settings-page.png)
*图 5-1：点击设置图标后进入设置页（左侧菜单完整展开）*

**步骤 2**：左侧菜单选 **AI 提供商 → 大语言模型（LLM）**：

![LLM 配置页](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/05c-llm-config.png)
...
![新建工作区对话框](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/06-new-workspace-dialog.png)
...
![建好的工作区](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/06-new-workspace-done.png)
...
![Attached vs RAG](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/07-chatting-with-documents/chatting-with-documents_introduction_1.png)
*图 7-1：Attached vs RAG 官方示意图*

![Document Pinning](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/07-chatting-with-documents/chatting-with-documents_introduction_4.png)
...
![Agent 配置](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/08-agent/agent_setup_1.png)
*图 8-1：Agent 配置入口（侧边栏设置 → 代理技能）*

![Agent Skills 按钮](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/08-agent/agent_setup_2.png)
...
![MCP 概览](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/09-mcp-compatibility/mcp-compatibility_overview_1.png)
*图 9-1：MCP 协议工作原理*

![MCP Desktop](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/09-mcp-compatibility/mcp-compatibility_overview_3.png)
...
![Flow 入门](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/10-agent-flows/agent-flows_getting-started_1.png)
*图 10-1：创建新 Flow*

![Flow 画布](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/10-agent-flows/agent-flows_getting-started_3.png)
*图 10-2：Flow 画布编辑*

![Flow 完成](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/10-agent-flows/agent-flows_getting-started_5.png)
*图 10-3：Flow 完成运行状态*
...
![Model Router](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/11-model-router/model-router_overview_1.png)
...
![任务创建](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/12-scheduled-jobs/scheduled-jobs_getting-started_1.png)
*图 12-1：创建新定时任务*

![Cron Builder](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/12-scheduled-jobs/scheduled-jobs_scheduling_1.png)
...
![System Prompt 变量](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/14-features/features_system-prompt-variables_3.png)
...
![Memories 设置](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/14-features/features_memories_1.png)
*图 14-2：Memories 配置入口*

![Memories 侧边栏](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/14-features/features_memories_2.png)
...
![Privacy 设置](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/14-features/features_privacy-and-data-handling_2.png)
*图 15-1：隐私与数据处理设置页*
...
![密码保护](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/14-features/features_security-and-access_2.png)
*图 15-2：单用户密码保护*
...
![更新页面](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/02-installation-desktop/installation-desktop_update_1.png)
*图 16-1：官方更新页面*
...
![Debug 页面](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/02-installation-desktop/installation-desktop_debug_1.png)
*图 17-1：官方调试日志页面*
...
![卸载页面](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/02-installation-desktop/installation-desktop_uninstall_1.png)
*图 18-1：官方卸载页面*
...
![Desktop Assistant](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/B1-desktop-assistant/desktop-assistant_features_1.png)
...
![Meeting Assistant](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/B2-meeting-assistant/meeting-assistant_features_1.png)
...
![Telegram 接入](https://cdn.jsdelivr.net/gh/langren34/doc@main/anythingllm-windows-guide/images/B3-channels/channels_telegram_1.png)
*图 B-3：Telegram 接入配置*
